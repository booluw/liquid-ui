...
<script setup>
import { LAccordion } from 'liquid-glass-ui';
const items = [
...
<ClientOnly>
<div class="max-w-xl mx-auto p-4 mb-8">
  <LAccordion :items="items" type="single" default-value="item-1" />
</div>
</ClientOnly>
